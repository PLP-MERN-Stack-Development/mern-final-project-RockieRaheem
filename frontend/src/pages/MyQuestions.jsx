            ...
            <div className="p-4 bg-card-light dark:bg-card-dark rounded-xl border border-border-light dark:border-border-dark">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <select
                    className="form-select w-full rounded-lg border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark focus:border-primary focus:ring-primary/50"
                    id="subject-filter"
                ...
                <div className="flex items-end">
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-primary/90"
                  >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        {/* Status Badge */}
                        <span
                          className={`inline-flex items-center gap-1.5 rounded-full bg-${question.statusColor}/10 px-2 py-0.5 text-xs font-medium text-${question.statusColor}`}
                        >
                    ...
                    <div className="flex-shrink-0 text-left sm:text-right">
                      <p className="text-sm font-medium">{question.timeAgo}</p>
